      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">May 25, 11:00, Holiday Inn Yerevan - Republic Square</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center bg-[#dadfe7] p-[5px] rounded-[6px]">11:00 ~ 11:30</p>
            </div>
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-gray-600 text-center bg-[#dadfe7] p-[5px] rounded-[6px]">11:30 ~ 12:30</p>
            </div>
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Module 2 | Anna</h4>
              <p className="text-gray-600 text-center bg-[#dadfe7] p-[5px] rounded-[6px]">12:30 ~ 13:30</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center bg-[#dadfe7] p-[5px] rounded-[6px]">30 minutes</p>
            </div>
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Module 3 | Babken</h4>
              <p className="text-gray-600 text-center bg-[#dadfe7] p-[5px] rounded-[6px]">14:00 ~ 15:00</p>
            </div>
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Module 4 | Lucy</h4>
              <p className="text-gray-600 text-center bg-[#dadfe7] p-[5px] rounded-[6px]">15:00 ~ 15:50</p>
            </div>
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">End</h4>
              <p className="text-gray-600 text-center bg-[#dadfe7] p-[5px] rounded-[6px]">15:50 ~ 16:00</p>
            </div>
